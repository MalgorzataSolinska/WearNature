...
import { setProducts, setLoading, setError, setProduct, productReviewd, resetError } from '../slices/products';
...
export const deleteProductsFromShop = () => async(dispatch) => { 
