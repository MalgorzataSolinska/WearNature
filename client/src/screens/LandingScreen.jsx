      ...
      >
        <Stack spacing={{ base: '8', lg: '10' }}>
          <Stack spacing={{ base: '2', lg: '4' }}>
            ...
            <Heading size='md' fontWeight='normal' justifyContent='center' textAlign='justify'>
              Znajdź swój wyjątkowy styl w naszych naturalnych ubraniach i daj im drugie życie.
            </Heading>
          </Stack>
          <HStack spacing='3'>
            <Link
